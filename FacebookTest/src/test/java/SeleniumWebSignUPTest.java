...
public class SeleniumWebSignUPTest{
    ...
    public void start() throws InterruptedException {
        ...
        driver.findElement(By.id("user_username")).sendKeys("Shafe1993");
        //6. Input an Email address in the email field
        driver.findElement(By.id("user_email")).sendKeys("Abrahamshafe1993@gmail.com");
        //7.Input Your password in the password field
        driver.findElement(By.id("user_password")).sendKeys("ShafeT2023");
        ...
        Thread.sleep(5000);
         ...
         driver.findElement(By.id("user_email")).sendKeys("AbrahamShafeT@gmail.com");
         //4. Input Your password in the password field
         driver.findElement(By.id("user_password")).sendKeys("Ashafet2023");
        ...
        Thread.sleep(5000);
        //2. Input your username on the username field
        driver.findElement(By.id("user_username")).sendKeys("Ajiish1234");
        //Test8.Verify that user cannot Sign UP with invalid email address
        //3. Input an Email address in the email field
        driver.findElement(By.id("user_email")).sendKeys("1993@.com");
        //4. Input Your password in the password field
        driver.findElement(By.id("user_password")).sendKeys("Ajishafet1234");
        //5. Click on Signup button
        driver.findElement(By.id("submit")).click();
        Thread.sleep(5000);
        //6. Click on Login button
        ...
        //Test10.Verify that user cannot Sign UP with either/all the fields blank
        //1. Click on Signup button to open the Signup page
        driver.findElement(By.xpath("//*[@id=\"bs-example-navbar-collapse-1\"]/ul/li[2]/a")).click();
        Thread.sleep(5000);
        //2. Input your username on the username field
        ...
        Thread.sleep(5000);
        //2. Input your username on the username field
        driver.findElement(By.id("user_username")).sendKeys("TshafeA45");
        //3. Input an Email address in the email field
        driver.findElement(By.id("user_email")).sendKeys("ShafeTech@gmail.com");
        //Test9.Verify that user cannot login with password less than or equal to one character
        //4. Input Your password in the password field
